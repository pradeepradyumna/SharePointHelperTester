...
These packages help you with a wrapper to do certain functionalities on SharePoint using C# .NET code which aren't directly available from [Microsoft.Graph](https://docs.microsoft.com/en-us/graph/overview) 
